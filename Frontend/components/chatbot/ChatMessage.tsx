...
export function ChatMessage({ message, onConfirmAction, onDismissAction, actionLoading }: Props) {
  ...
  return (
    <div className={cn("flex flex-col gap-1", isUser ? "items-end" : "items-start")}>
      <div
        className={cn(
          "max-w-[85%] rounded-[18px] px-5 py-4 text-sm leading-relaxed shadow-sm",
          isUser
