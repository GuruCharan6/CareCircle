  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-h-dvh lg:min-h-0 lg:items-center lg:justify-center lg:bg-[#F5F3EE] lg:p-10">
        ...
        {/* Form section */}
        <div className="flex-1 w-full bg-white rounded-t-3xl lg:rounded-2xl lg:border lg:border-[#D9D5CD] lg:shadow-sm lg:max-w-sm px-6 pt-7 pb-10 lg:p-8 overflow-y-auto">
          {children}
        </div>
      </div>
    </div>
