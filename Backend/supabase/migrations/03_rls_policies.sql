-- ============================================
-- FILE: Row Level Security Policies
-- DESCRIPTION: RLS enable + all policies for all 21 tables.
--              All patient-scoped tables use get_user_patient_ids() helper
--              (defined in functions_and_triggers file).
...
-- ============================================
-- RLS POLICIES: drug_interaction_results
-- ============================================
...
-- ============================================
-- RLS POLICIES: drug_generic_lookup
-- ============================================
...
-- ============================================
-- RLS POLICIES: medication_refills
-- ============================================
...
-- ============================================
-- RLS POLICIES: clinical_hypotheses
-- ============================================
